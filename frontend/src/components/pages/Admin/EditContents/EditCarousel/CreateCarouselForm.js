...
export default function CarouselForm(prop) {
  ...
  const descForm =isEditForm ?
    <Form.Control onChange={prop.handleDesc} as="textarea" placeholder= {prop.currentItem.description} /> :
    ...
    <div className="editContent__carousel-form-container">
      <Form validated onSubmit={prop.handleSubmit}>
        ...
        <Form.Group controlId="formFileUpload">
          <Form.File onChange={prop.handleImg} accept=".jpg, .jpeg., .png" label="Banner Image (e.g., .png/jpeg/jpg files) [Optimal Img Size: 2700 x 900 pixels]"/>
        </Form.Group>
        <Modal.Footer>
